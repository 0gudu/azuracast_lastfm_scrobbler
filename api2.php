...
$stmt = $pdo->prepare("UPDATE acessos SET char1 = :apikey, char2 = :secrett, char4 = :token WHERE uniqueidclient = 'soja'");	
...
$stmt = $pdo->prepare("UPDATE acessos SET apikeyscrobble = :sessionss WHERE uniqueidclient = 'soja'");	
